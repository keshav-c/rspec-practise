class NotesController < ApplicationController
  before_action :set_project # gets project in instance variable
  before_action :project_owner? # checks if current user is owner
  before_action :set_note, only: %i[ show edit update destroy ]

  # GET /project/:id/notes
  def index
    @notes = @project.notes
  end
  ...
  def create
    # This is done because of the association choice:
